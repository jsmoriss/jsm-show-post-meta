...
<tr><th align="right" valign="top" nowrap>Stable Version</th><td>1.0.4-1</td></tr>
...
<p>There are no plugin settings to update or adjust &mdash; simply activate to add a metabox to all post editing pages.</p>
